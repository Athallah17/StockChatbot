...
system_prompt = (
    ...
    "  {\n    \"action\": null,\n    \"payload\": {}\n  }\n"
    "\n"
    "- \"payload\": a dictionary of parameters required for the action (e.g., \"tickers\", \"period\", \"interval\", \"n_days\", \"message\", \"limit\", \"category\")\n"
    "- For \"general_information\", include { \"message\": \"original user question\" } as the payload\n"
    "- For \"get_predict_price\", always include \"n_days\"\n"
    "- For \"get_top_tickers\", always include \"category\" and \"limit\"\n"
